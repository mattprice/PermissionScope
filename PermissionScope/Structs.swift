...
@objc public enum PermissionType: Int, CustomStringConvertible {
    case contacts, locationAlways, locationInUse, notifications, microphone, camera, photos, reminders, events, bluetooth, bluetoothPower, motion
    ...
    public var description: String {
        ...
        case .bluetoothPower:   return "Bluetooth"
        case .motion:           return "Motion"
        }
    }
    
    static let allValues = [contacts, locationAlways, locationInUse, notifications, microphone, camera, photos, reminders, events, bluetooth, bluetoothPower, motion]
}
